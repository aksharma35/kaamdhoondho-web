  ...
  template: `
    <div class="min-h-screen bg-[#fffbf2]">
      ...
      <main class="flex flex-col items-center justify-center py-32 text-center px-4">
        <p class="text-5xl">👷</p>
        <h1 class="font-extrabold text-2xl text-[#1e2d2c] mt-4">Find Work / काम खोजें</h1>
        <p class="text-[#6b8280] mt-2">Nearby jobs will appear here. / पास की नौकरियां यहां दिखेंगी।</p>
      </main>
    </div>
  `,
})
